...
export default function RegisterPage() {
  ...
  const { loading: geoLoading, error: geoError, address: geoAddress, getCurrentLocation } = useGeolocation();
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // 2. Create user profile with service role client to bypass RLS
        ...
        .insert([
          {
            ...
            phone: formData.phone,
            address: formData.address,
            password_hash: 'HASHED_' + formData.password, // This is just for the required field
            profile: 'user',
