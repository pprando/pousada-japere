        ...
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-moss text-white hover:bg-moss/90 px-4 py-2 rounded-lg transition-colors"
            >
              Começar Agora
            </button>
          </div>
              ...
              <div className="mt-8">
                <form className="sm:flex">
                  ...
                  <div className="mt-3 rounded-lg sm:mt-0 sm:ml-3 sm:flex-shrink-0">
                    <button
                      type="submit"
                      className="flex w-full items-center justify-center rounded-lg bg-moss px-4 py-3 font-medium text-white hover:bg-moss/90 focus:outline-none focus:ring-2 focus:ring-moss focus:ring-offset-2"
                    >
                      Teste Grátis
