...
export default function MenuControlPage() {
  ...
  const fetchOccupiedRooms = async () => {
    try {
      // Buscar apenas quartos com reservas confirmadas
      ...
      const occupiedRooms = data
        .filter(booking => booking.room) // Garantir que o quarto existe
        .map(booking => ({
  ...
  const menuItems = {
    porcoes: [
      { id: 'p1', name: 'Batata Frita 500gr', price: 45.90 },
      { id: 'p2', name: 'Bolinho de Bacalhau (12 unid)', price: 55.90 },
      { id: 'p3', name: 'Bolinho de Queijo (12 unid)', price: 45.90 },
      { id: 'p4', name: 'Carne de Sol 400gr', price: 65.90 },
      { id: 'p5', name: 'Frango à Passarinho 500gr', price: 45.90 },
      { id: 'p6', name: 'Filé de Frango 500gr', price: 45.90 },
    ],
    caldos: [
      { id: 'c1', name: 'Caldo de Abóbora 400 ml', price: 45.90 },
      { id: 'c2', name: 'Caldo de Feijão com Costela 400 ml', price: 45.90 },
      { id: 'c3', name: 'Caldo Verde 400 ml', price: 45.90 },
    ],
    bebidas: [
      { id: 'b1', name: 'Água sem Gás 500ml', price: 4.90 },
      { id: 'b2', name: 'Água com Gás 500ml', price: 5.90 },
      { id: 'b3', name: 'Coca Cola Zero Lata', price: 5.90 },
      { id: 'b4', name: 'Guaraná Antarctica Lata', price: 5.90 },
    ],
    vinhos: [
      { id: 'v1', name: 'VH Cabernet Sauvignon', price: 89.90 },
      { id: 'v2', name: 'VH Chardonnay', price: 89.90 },
      { id: 'v3', name: 'VH Merlot', price: 89.90 },
    ],
  };

  const handleAddItem = (item: Omit<MenuItem, 'quantity'>) => {
    if (!selectedRoom) {
  ...
  const renderMenuItem = (item: Omit<MenuItem, 'quantity'>, category: string) => (
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {menuItems.porcoes.map(item => renderMenuItem(item, 'porcoes'))}
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {menuItems.caldos.map(item => renderMenuItem(item, 'caldos'))}
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {menuItems.bebidas.map(item => renderMenuItem(item, 'bebidas'))}
                </div>
              </div>
              ...
              <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {menuItems.vinhos.map(item => renderMenuItem(item, 'vinhos'))}
                </div>
              </div>
            </div>
