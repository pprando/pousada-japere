...
import { Check, X, Clock, Calendar, User, Mail, Phone, MapPin, BedDouble, CreditCard, FileText, Trash2 } from 'lucide-react';
                    ...
                    <div className="border-t border-gray-100 pt-6">
                      <div className="flex gap-3">
                        ...
                        {selectedRequest.status === 'approved' && (
                          <button
                            onClick={() => navigate(`/bookings/create/${selectedRequest.id}`)}
